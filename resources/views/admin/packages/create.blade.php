    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <form action="{{ route('admin.packages.store') }}" method="POST">
            ...
            <div class="flex items-center justify-between">
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Add Package</button>
